...
def spanish_and_brazilian_fruits(spanish_fruits, brazilian_fruits):
    ...
    result = brazilian_fruits & spanish_fruits
    return list(result)

def spanish_and_japan_fruits(spanish_fruits, japanese_fruits):

    result = spanish_fruits & japanese_fruits
    return list(result)

def popular_spanish_or_brazilian_fruits(popular_fruits, spanish_fruits, brazilian_fruits):

    union_result = spanish_fruits | brazilian_fruits
    result = popular_fruits & union_result

    return list(result)

def popular_only_spanish_fruits(popular_fruits, spanish_fruits, japanese_fruits, brazilian_fruits):

    union_result = japanese_fruits | brazilian_fruits
    difference_result = spanish_fruits - union_result
    result = popular_fruits & difference_result
...
if __name__ == "__main__":
    ...
    print(spanish_and_japan_fruits(spanish_fruits, japanese_fruits))
    ...
    print(only_yahoo_emails(emails_list))